...
You can find the completed code on the `complete` branch of this repo: [package.json](https://github.com/how-to-firebase/secrets/blob/complete/functions/package.json)
